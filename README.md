...
A zsh plugin that provides intelligent tab completion for `python -m` commands with full module path results and smart project detection.
...
python -m<TAB>           # Shows available local module paths
python -m <TAB>          # Shows available local module paths
